...
namespace MakeMyTrip.Api.Controllers.Module
{
    ...
    public class SearchGetTrainDetailController : ControllerBase
    {
        private IDbContextManager<MainSqlDbContext> DbContextManager { get; set; }
        public SearchGetTrainDetailController(IDbContextManager<MainSqlDbContext> dbContextManager) {
        ...
        public async Task<IActionResult> Post([FromBody]Dictionary<string,string> searchParams)
        {
            ...
            var result = await DbContextManager.StoreProc<StoreProcResult>("[dbo].spGetTrainDetails", spParameters);
